...
public class CityTask implements NetworkResponseListener {
    ...
    public CityTask(Context context, Object instanceOfClass) {
    ...
    public void getDetails(String country){
        ...
        String data = "T" + AppConstants.RESPONSE_SPLITTER_STRING
                + country + AppConstants.RESPONSE_SPLITTER_STRING
                + AppConstants.END_OF_URL;
        pojo.setData(data);

        PostResponseAsync getSpinnersData = new PostResponseAsync(context, CityTask.this);
        getSpinnersData.setResponseListener(CityTask.this);
    ...
    public void notifyNetworkResponseSuccess(String response) {
        if(response != null) {
            if (response.startsWith(AppConstants.SUCCESS_STRING_PREFIX)) {
                ...
                FatcaVO fatcaVO;
                fatcaVO = new FatcaVO();
                fatcaVO.setCountryName("Select City");
                ...
                getCityListener.getOtherCityList(countryListAl);
            }
        }
    }
    ...
    public void setDetailsListener(GetCityListener getCityListener) {
