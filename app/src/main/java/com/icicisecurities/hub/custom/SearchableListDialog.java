...
public class SearchableListDialog extends DialogFragment implements
    ...
    private void setData(View rootView) {
        ...
        listAdapter = new ArrayAdapter(getActivity(), R.layout.spinner_textview,
                items);
...
//                _listViewItems.clearTextFilter();
            ...
            ((ArrayAdapter) _listViewItems.getAdapter()).getFilter().filter(newText);
        }
...
}//SearchableListDialog closes here....
